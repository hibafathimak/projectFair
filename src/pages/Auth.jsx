        ...
        <div className="shadow car p-2">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 px-5">
              <h1 className="mt-2"><i class="fa-solid fa-laptop-code me-4"></i>
                Project Fair</h1>
              ...
              <Form>
                ...
                <FloatingLabel controlId="floatingPassword" label="Password">
...

                  {
                    ...
                    :
                    <div className="mt-3">
                      <button onClick={handleLogin} className='btn btn-outline-info py-2 px-3 mb-2'>Login       
                       { isLogined && <Spinner animation="border" className='ms-1' variant="light" size="sm"  />}
                      </button>
